...
## Current state
- **Phase:** 1 IN PROGRESS — checkpoints 1.0–1.4 shipped (of 1.0–1.10).
- **Blocking:** none.
- **Last session:** 2026-07-14 — Checkpoint 1.4 (index membership: IVV primary + Wikipedia cross-check + reconciler, FR-4); Data tests **81**, `tools/ci.ps1` green (**103** total). See the session-log entry.
