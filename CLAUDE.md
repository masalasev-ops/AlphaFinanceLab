...
- docs/BUILD_AND_PROMPTS_v1.9.md — FR-1..42, phase plan, phase prompts (Phase 0 is structured as checkpoints 0.1–0.6 with the pinned versions, the no-AUTOINCREMENT migration hand-edit, the 404→D60 fallback, and the ASCII-only .ps1 rule)
