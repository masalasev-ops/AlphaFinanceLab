...
- docs/MASTER_DESIGN_v1.9.md — decisions D1–D85, architecture, golden rules, math appendix, UI boundary (§21–22)
...
- docs/CHANGELOG_v1.9.md — every consistency finding + decision (D1–D85), the provenance trace
