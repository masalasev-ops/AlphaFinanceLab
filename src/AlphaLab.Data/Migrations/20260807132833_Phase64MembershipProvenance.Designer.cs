...
namespace AlphaLab.Data.Migrations
{
    ...
    [Migration("20260807132833_Phase64MembershipProvenance")]
    partial class Phase64MembershipProvenance
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AlphaLab.Data.Entities.JournalEntryRow", b =>
                {
                    ...
                    b.ToTable("journal_entries", null, t =>
                        {
                            t.HasCheckConstraint("ck_journal_entries_kind", "kind IN ('hypothesis','observation','decision_note','skeptic_review','outcome')");
